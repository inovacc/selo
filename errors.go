...
var (
	...
	ErrInvalidLength = errors.New("selo: invalid document length")
	// ErrInvalidFormat indicates the document does not match the expected shape.
	ErrInvalidFormat = errors.New("selo: invalid document format")
	// ErrUnknownKind indicates a Kind that is not registered.
	ErrUnknownKind = errors.New("selo: unknown document kind")
	// ErrUnsupported indicates an operation is not supported for the given Kind.
	ErrUnsupported = errors.New("selo: operation not supported for this kind")
	// ErrUFNotImplemented indicates the requested federative unit has no implementation yet.
	ErrUFNotImplemented = errors.New("selo: federative unit not implemented")
)
